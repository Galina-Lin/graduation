...
// 	version: '1.0.0',
// });
export const payRequest = (merchantOrderNo, userId) => { return {} };
...
export const recharge = (id, balance) => fetch('/promotion/recharge/' + id + '?balance=' + balance);
...
export const setUser = (key, val) => fetch('/v1/user/updInfo/'+getStore('user_id'), {key, val});
...
export const setOrderStatus = (order_id, status) => fetch('/bos/orders/setStatus', {
	order_id,
	status,
});
...
export const uploadAssess = (username,usericon,shopid,orderinfo,star,imgArr,text) => fetch('/eus/v1/users/uploadAssess', {
	username,
	usericon,
	shopid,
	orderinfo,
