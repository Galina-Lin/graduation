    ...
    <div class="profile_page">
        ...
        <section>
            <section class="profile-number">
                <div :to="userInfo&&userInfo.user_id? '/profile/info' : '/login'" class="profile-link">
            ...
            <section class="info-data">
                <ul class="clear">
                    <router-link to="/balance" tag="li" class="info-data-link" style="cursor:pointer">
                        <span class="info-data-top"><b>{{parseInt(balance).toFixed(2)}}</b>元</span>
                        <span class="info-data-bottom">我的余额</span>
                    </router-link>
<!--                     <router-link to="/benefit" tag="li" class="info-data-link" style="cursor:pointer">
                        <span class="info-data-top"><b>{{count}}</b>个</span>
                        <span class="info-data-bottom">我的优惠</span>
                    </router-link> -->
                    <router-link to="/points" tag="li" class="info-data-link" style="cursor:pointer">
