 <template>
    <div class="rating_page">
        <section class="profile-info">
            ...
            <router-link to="/profile/setusername/username" class="info-router">
            ...
            <router-link to="/profile/setusername/mobile" class="info-router">
            ...
            <router-link to="/profile/setusername/email" class="info-router">
                <section class="info-router">
                    <section class="headportrait headportraitwo headportraithree">
                            <h2><img src="../../../images/add_address.png" style="display:inline-block;margin-right:.4rem;width:20px" alt="">邮箱</h2>
                            <div class="headportrait-div">
                                <p>{{infomail}}</p>
                                <span class="headportrait-div-bottom">
                                    <svg fill="#d8d8d8">
