<template>
  	<div class="city_container">
        ...
        <form class="city_form" v-on:submit.prevent>
            ...
            <div>
                <input type="submit" name="submit" class="city_submit input_style" @click='postpois' value="提交" style="cursor:pointer">
            </div>
        </form>
        <header v-if="historytitle" class="pois_search_history">搜索历史</header>
        <ul class="getpois_ul">
            <li v-for="(item, index) in placelist" @click='nextpage(index, item.geohash)' :key="index" style="cursor:pointer">
