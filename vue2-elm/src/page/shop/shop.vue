 <template>
    <div>
        <head-top go-back='true' head-title="店铺详情"></head-top>
        <section v-if="!showLoading" class="shop_container">
                ...
                <section class="description_header">
                    <router-link to="/shop/shopDetail" class="description_top">
                        ...
                        <section class="description_right">
                            ...
                            <p class="description_text">商家电话：{{shopDetailData.phone}}／快递费¥{{shopDetailData.float_delivery_fee}}</p>
            ...
            <section class="change_show_type" ref="chooseType">
                <div>
                    <span :class='{activity_show: changeShowType =="food"}' @click="changeShowType='food'" style="cursor:pointer">商品</span>
                </div>
                <div>
                    <span :class='{activity_show: changeShowType =="rating"}' @click="changeShowType='rating'" style="cursor:pointer">评价</span>
                </div>
            </section>
                                            ...
                                            <section class="menu_food_description">
                                                <h3 class="food_description_head">
                                                    ...
                                                    <ul v-if="foods.attributes.length" class="attributes_ul">
                                                        <li v-for="(attribute, foodindex) in foods.attributes" :key="foodindex" :style="{color: '#' + attribute.icon_color,borderColor:'#' +attribute.icon_color}" :class="{attribute_new: attribute.icon_name == '新'}" style="height:1rem;line-height:.7rem">
                                                        <p :style="{color: attribute.icon_name == '新'? '#fff' : '#' + attribute.icon_color}" style="display:inline-block;height:1rem">{{attribute.icon_name == '新'? '新品':attribute.icon_name}}</p>
                                                        </li>
                                                    </ul>
...
<!--                                                     <span>月售{{foods.month_sales}}份</span>
                    ...
                    <section class="buy_cart_container">
                        <section @click="toggleCartList" class="cart_icon_num">
                            ...
                            <div class="cart_num">
                                <div>¥ {{totalPrice}}</div>
                                <div>快递费 ¥{{deliveryFee}}</div>
                            </div>
                        </section>
                        <section class="gotopay" :class="{gotopay_acitvity: minimumOrderAmount <= 0}">
                            <span class="gotopay_button_style" v-if="minimumOrderAmount > 0" style="cursor:no-drop">还差{{minimumOrderAmount}}元起送</span>
                        ...
                        <section>
                            ...
                            <header class="rating_header">
                                <section class="rating_header_left">
                                    <p>{{ratingScoresData.overall_score}}</p>
                                    <p>综合评价</p>
                                    <p>认证商家</p>
                                </section>
                                        ...
                                        <header>
                                            <section class="username_star">
                                                ...
                                                <p class="star_desc">
                                                    ...
                                                    <span class="time_spent_desc" style="margin-left:.5rem">{{item.username}} 购买了 {{item.time_spent_desc.slice(0,item.time_spent_desc.length-2)}}</span><br>
                                                    <div style="margin-top:.3rem;font-size:20px;">{{item.rating_text}}</div>
                                                </p>
                                            </section>
    ...
    export default {
        ...
        computed: {
            ...
            promotionInfo: function (){
                return this.shopDetailData.promotion_info || '谢谢。'
            },
            //配送费
